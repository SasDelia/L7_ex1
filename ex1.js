...
function NameToJob() {
	document.getElementById("NumePrenume").innerHTML = "Technician sisteme de securitate / telecomunicatii"; //schimba numele cu functia pe care dorim sa o avem
}
...
function oldToNewImage() {
	...
	img.src = "Delia2.jfif"; //schimba poza
...
function changeBodyBackgroundColor() {
	...
	body.style.backgroundColor  = "#d6d198";//schimba background-ul
